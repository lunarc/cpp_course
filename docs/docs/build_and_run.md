...
![Image title](images/qtcreator-installer4-linux.png){ width="100%" }
...
![Image title](images/qtcreator-project-1.png){ width="100%" }
...
![Image title](images/qtcreator-project-2.png){ width="100%" }

In the next page we need to specify the name and location of the new project.

![Image title](images/qtcreator-project-3.png){ width="100%" }
...
![Image title](images/qtcreator-project-4.png){ width="100%" }
...
![Image title](images/qtcreator-project-5.png){ width="100%" }

If you want to use version control this can be specified in the following step.

![Image title](images/qtcreator-project-6.png){ width="100%" }
...
![Image title](images/qtcreator-project-7.png){ width="100%" }
...
![Image title](images/qtcreator-build-button.png){ width="10%" }
...
![Image title](images/qtcreator-play-button.png){ width="10%" }
...
![Image title](images/qtcreator-run-1.png){ width="100%" }
...
![Image title](images/qtcreator-create-new-file-1.png){ width="100%" }
...
![Image title](images/qtcreator-create-new-file-2.png){ width="50%" }
